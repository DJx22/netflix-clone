...
{
    /// <summary>Gets the ADO.NET connection string for the Payment service's SQL Server database (ADR 0001).</summary>
    public string PaymentDb { get; init; } = string.Empty;
}
