...
/// <summary>
/// Single extension method that wires every service for the Payment API.
/// §7: all registration lives here — nothing scattered across Program.cs.
/// </summary>
public static class DependencyInjection
{
    /// <summary>
    /// Registers all services required by the Payment API.
    /// </summary>
    public static IServiceCollection AddPaymentServices(
        this IServiceCollection services,
        IConfiguration configuration)
    {
        // ── Infrastructure (DbContext, repositories, DateTimeProvider, simulator, event publisher) ──
        services.AddInfrastructure(configuration);

        // ── Application services ──────────────────────────────────────────────
        // Plain service class — no Mediator; reads and writes share one shape.
        ...
        services.AddAuthentication(options =>
            ...
            .AddJwtBearer(options =>
            {
                ...
                // This must match the claim-reading pattern in PaymentsController.GetAccountId().
