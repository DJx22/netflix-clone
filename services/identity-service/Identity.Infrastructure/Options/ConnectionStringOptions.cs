...
public sealed class ConnectionStringOptions
{
    ...
    /// <summary>
    /// Connection string for IdentityDb on the shared SQL Server container (ADR 0001).
    /// Must point only at IdentityDb — no cross-service connection strings here.
    /// </summary>
    public string IdentityDb { get; init; } = string.Empty;
}
